...
describe('api', () => {
    ...
    it('adds csrf header for mutating requests', async () => {
        ...
        expect(globalThis.fetch).toHaveBeenCalledWith(`${API_BASE_URL}/messages`, expect.objectContaining({
            method: 'POST',
            credentials: 'include',
    ...
    it('omits csrf header for get requests', async () => {
        ...
        expect(globalThis.fetch).toHaveBeenCalledWith(`${API_BASE_URL}/bootstrap`, expect.objectContaining({
