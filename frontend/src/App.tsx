...
function AuthScreen({ authUser, mode, onLogin, onShowToast }: Readonly<AuthScreenProps>) {
  if (authUser) {
...
function HomeRedirect({ authUser, isAuthBootstrapping }: Readonly<HomeRedirectProps>) {
